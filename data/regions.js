  ...
  regions: [
    {
      ...
      paragraphs: [
        'The Coastal Plains region stretches along the Gulf of Mexico in the east and south part of Texas. It reaches inland to the Balcones Escarpment (a steep cliff where the land suddenly rises up) and north to the Red River. This region has four smaller parts, called subregions. The Gulf Coastal Plain sits right along the coast, with wetlands (low, soggy land) and barrier islands (long strips of sand that protect the coast from waves), near Corpus Christi, Galveston, Brownsville, and Laredo. The Piney Woods, in East Texas, is covered in thick pine and hardwood forest, near Tyler and Beaumont. The Post Oak Belt is a strip of scattered trees between the forest and the prairie. The Blackland Prairie has rich, dark soil that is great for farming and stretches from the Red River down to San Antonio, passing by Dallas and the eastern edge of Austin. Houston is the region’s biggest city.',
